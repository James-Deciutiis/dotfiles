...
bindings.globalkeys = gears.table.join(awful.key({modkey}, "s",
...
end), awful.key({modkey, "Control"}, "Left",
...
end), awful.key({modkey, "Shift"}, "Left",
                function() awful.client.moveresize(-20, 0, 0, 0) end),
                                       awful.key({modkey, "Shift"}, "Right",
                                                 function()
    awful.client.moveresize(20, 0, 0, 0)
end), awful.key({modkey, "Control"}, "n", function()
...
bindings.clientkeys = gears.table.join(awful.key({modkey}, "f", function(c)
