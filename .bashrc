...
alias goto_wow_addon_dir='cd Games/world-of-warcraft/drive_c/Program\ Files\ \(x86\)/World\ of\ Warcraft/_retail_/Interface/AddOns/'

export PATH=$PATH:~/Documents/code/scripts
